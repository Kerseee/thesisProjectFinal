...
std::ostream& operator<<(std::ostream& os, const data::Scale& scale){
    os << "num room type: " << scale.room_type << "\n";
    os << "num order type: " << scale.order_type << "\n";
    os << "num booking period: " << scale.booking_period << "\n";
    os << "num service period: " << scale.service_period << "\n";
    return os;
}
